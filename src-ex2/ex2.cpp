...
int main ()
{
  ...
  /* fill in the blocks for sha256 with the bitcoin genesis block header data*/
  ...
  /* padding for 80 bytes message to digest*/
  ...
  /* re-initialize block1 for second hash */
  ...
  /* print deouble hashs result to cout */
